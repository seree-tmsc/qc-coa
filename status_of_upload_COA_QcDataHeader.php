<h3 style="color:red">Status of upload Table COA_QcDataHeder :</h3>

<div class='table-responsive'>    
    <table class='table table-bordered table-hover' id='myTable_COA_QcDataHeader' style='width:100%;' align="center">
        <thead> 
            <tr class='info'>
...
<?php
        ...
        $strSql = "SELECT TOP 3 * " ;
        //$strSql = "SELECT * ";
        $strSql .= "FROM TRANS_History_Upload_COA_QcDataHeader ";        
        $strSql .= "ORDER BY customer, material ";
        //echo $strSql . "<br>";
