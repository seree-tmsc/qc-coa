                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-lg-offset-0 showStatus">                            
                            <?php
                                $param_salesDataMode='view';
                                require_once("status_of_upload_COA_SalesData.php");
                            ?>
                            <hr>                            
                            <?php //require_once("status_of_upload_COA_VF05.php"); ?>                            
                            <?php require_once("status_of_upload_COA_VL06O.php"); ?>
                            <hr>
                            <?php 
                                $param_inspectionDataMode='view';
                                require_once("status_of_upload_COA_QcDataDetail.php"); ?>
                            <hr>
                            <?php require_once("status_of_upload_COA_QcDataHeader.php"); ?>
                        </div>
                    </div>
