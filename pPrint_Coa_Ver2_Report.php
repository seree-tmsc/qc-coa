<?php
    /*
    echo $_POST['invoice_no'] . "<br>";
    echo $_POST['lot_no'] . "<br>";
    */
    ...
    try
    {
        ...
        {
            $tmpString = $_POST['invoice_no'];
            $nPosition = stripos($tmpString, '/');            
            $cInvoice = substr($tmpString, 0, $nPosition);
            //echo $cInvoice . "<br>";
            
            $tmpString = substr($tmpString, $nPosition+1);
            $nPosition = stripos($tmpString, '/');
            $cDelivery = substr($tmpString, 0, $nPosition);
            //echo $cDelivery . "<br>";
            ...
            $tmpString = $_POST['lot_no'];
            $nPosition = stripos($tmpString, '/');
            $cMaterial = substr($tmpString, 0, $nPosition);
            //echo $cMaterial . "<br>";

            $tmpString = substr($tmpString, $nPosition+1);
            $nPosition = stripos($tmpString, '/');
            $cLot = substr($tmpString, 0, $nPosition);
            //echo $cLot . "<br>";
            ...
            {   
                ...
                $strSqlTmp = "SELECT * FROM COA_VL06O ";
                $strSqlTmp .= "WHERE Delivery = '" . $cDelivery . "' ";
                $strSqlTmp .= "AND Material = '" . $cMaterial . "' ";
                $strSqlTmp .= "AND Batch = '" . $cLot . "' ";
                $strSqlTmp .= "AND [Delivery quantity] = " . $nQuantity . " ";
                //echo $strSqlTmp . "<br>";
                ...
                if($nRecCountTmp == 1)
                {
                    ...
                    $nOrd_Qty = $dsTmp['Delivery quantity'];
                }
            }
            else
            {
